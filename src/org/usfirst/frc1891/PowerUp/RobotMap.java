...
public class RobotMap {
	...
	public static WPI_TalonSRX wheeledIntakeLeft;
	public static WPI_TalonSRX wheeledIntakeRight;
...
//        driveSystemLeftMasterTalon.enableVoltageCompensation(true);
        ...
        driveSystemLeftMasterTalon.configClosedloopRamp(0.25, timeoutMs);
...
//        driveSystemRightMasterTalon.enableVoltageCompensation(true);
        ...
        driveSystemRightMasterTalon.configClosedloopRamp(0.25, timeoutMs);
        ...
        liftMotorTalon.configContinuousCurrentLimit(25, timeoutMs);
        liftMotorTalon.configPeakCurrentLimit(50, timeoutMs);
        liftMotorTalon.configPeakCurrentDuration(200, timeoutMs);
        liftMotorTalon.enableCurrentLimit(true);
        
        liftMotorTalon.configReverseLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyOpen, timeoutMs);
        
//        liftMotorTalon.configForwardLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyClosed, timeoutMs);
...
//        ahrs = new AHRS(Port.kMXP);
        ...
        wheeledIntakeLeft = new WPI_TalonSRX(7);
        wheeledIntakeLeft.set(ControlMode.PercentOutput, 0);
        wheeledIntakeRight = new WPI_TalonSRX(6);
        wheeledIntakeRight.set(ControlMode.PercentOutput, 0);
