...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveSystemLeftMasterTalon.selectProfileSlot(1, 0);
        driveSystemLeftMasterTalon.config_kF(1, 0, timeoutMs);
        ...
        driveSystemRightMasterTalon.selectProfileSlot(1, 0);
        driveSystemRightMasterTalon.config_kF(1, 0, timeoutMs);
