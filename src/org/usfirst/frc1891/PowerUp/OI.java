...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Drive Forward", new DriveForwardAuto());
...
//    	return throttleStick.getRawAxis(1);
    	return cube(throttleStick.getRawAxis(1) * 1.28);
    }
    
    public double getTurning() {
//    	return -turningStick.getRawAxis(0);
    	return square(-throttleStick.getRawAxis(5) * 1.28);		
    }
    
    public boolean getQuickTurn() {
//    	return turningStick.getRawButton(2);
